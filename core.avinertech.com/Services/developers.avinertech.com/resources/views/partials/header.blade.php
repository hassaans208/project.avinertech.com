s<header class="px-6 py-4 fixed top-0 w-full bg-gray-800 shadow-lg flex items-center justify-between z-50">
    <!-- Logo & Brand -->
    ...
    <nav class="hidden md:flex gap-6 text-gray-400 text-lg">
        ...
        <a href="mailto:sales@avinertech.com" class="hover:text-white transition text-blue-400">Contact Seller</a>
    </nav>
    ...
    <div id="mobile-menu" class="hidden absolute top-16 left-0 w-full bg-gray-800 shadow-md p-4 flex flex-col gap-4 text-lg md:hidden">
        ...
        <a href="{{url('/what-we-do')}}" class="text-gray-400 hover:text-white transition">What We Do?</a>
        <a href="{{url('https://developers.avinertech.com/')}}" class="text-gray-400 hover:text-white transition">API References</a>
        <a href="mailto:sales@avinertech.com" class="text-blue-400 hover:text-white transition">Contact Seller</a>
    </div>
</header>
