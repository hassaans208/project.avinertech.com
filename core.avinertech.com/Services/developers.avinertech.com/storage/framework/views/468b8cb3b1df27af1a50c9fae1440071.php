...
<header class="px-6 fixed py-3 w-full bg-slate-800 flex items-center justify-between">
    <div class="flex items-center">
        <img src="<?php echo e(asset('/images/logo.png')); ?>" width="12%" />
        <p class="text-2xl text-white" >vinerTech</p>
    </div>
    <div class="flex items-center gap-2">
        <a href="" class="text-gray-400 underline">What we do?</a>
        <a href="" class="text-gray-400 underline">Service References</a>
        <a href="" class="text-gray-400 underline">API References</a>
    </div>
</header>
<!-- Sidebar -->
