...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="max-w-lg w-full bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <!-- Drop Zone -->
        <div id="dropZone"
             class="w-full p-6 border-2 border-dashed border-gray-600 rounded-lg text-center cursor-pointer hover:bg-gray-700 transition"
    ...
    <script>
        ...
        async function uploadFiles() {
            ...
            try {
                ...
                if (result.status) {
                    showMessage(`<button id="copyButton" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded flex items-center gap-2" data-target='{{url('/api')}}/${result?.path}'>Copy Secure Link & Share with anyone</button>`, "bg-green-500");
                    selectedFiles = [];
                    previewContainer.innerHTML = "";
