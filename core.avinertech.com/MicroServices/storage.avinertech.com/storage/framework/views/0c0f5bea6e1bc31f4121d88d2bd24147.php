...
<header class="px-8 py-4 fixed top-0 w-full bg-gray-800 shadow-lg flex items-center justify-between z-50">
    ...
    <nav class="flex gap-6 text-gray-400 text-lg">
        ...
        <a href="/cloud-storage" class="hover:text-white transition text-blue-400">Cloud Storage</a>
    </nav>
</header>
...
scp -i ~/.ssh/id_rsa yourfile.png user@storage.avinertech.com:/uploads/
        ...
        <div class="mt-10 text-center">
            ...
            <a href="/contact" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg text-lg mt-4">
                Contact Us
            </a>
        </div>
    </div>
