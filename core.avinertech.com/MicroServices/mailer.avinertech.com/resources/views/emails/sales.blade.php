    ...
    <div class="wrapper">
      <div class="container">
        ...
        <div class="hero">
          <div class="glow"></div>
          <h1>{{ $subjectLine }}</h1>
          <div class="meta">From <span class="mono">{{ $fromName ?: $fromEmail }}</span> to <span class="mono">{{ $toName ?: $toEmail }}</span></div>
          <div class="pill" style="margin-top:12px;">Customer Inquiry</div>
        </div>

        <div class="card">
          <div class="label">Message</div>
          <div class="content">{!! nl2br(e($messageContent)) !!}</div>
          ...
          <div style="margin-top:16px; display:grid; gap:12px; grid-template-columns:repeat(2,minmax(0,1fr));">
            ...
            <div>
              ...
              <div class="value">{{ $toName ?: '—' }} &lt;{{ $toEmail }}&gt;</div>
            </div>
          </div>
        </div>
