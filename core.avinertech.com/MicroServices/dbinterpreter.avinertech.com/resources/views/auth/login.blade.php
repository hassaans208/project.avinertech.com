...
<head>
    ...
    <title>Signal Application - Login</title>
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    A centralised application for managing all your signal applications
                </p>
            </div>
            ...
            <div class="bg-white py-8 px-6 shadow rounded-lg">
                ...
                {{-- <div class="mt-6 border-t border-gray-200 pt-6"> --}}
                    {{-- <div class="text-sm text-gray-600">
                        ...
                        Super Admin: admin@avinertech.com / admin27901<br>
                        Tenant Admin: john@prototype.com / admin27901
                    </div> --}}
                {{-- </div> --}}
            </div>
        </div>
