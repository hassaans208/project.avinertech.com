<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
        <div class="p-6">
            <form action="{{ route('packages.store', ['access_token' => $accessToken]) }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="cost" id="cost" value="{{ old('cost', '0.00') }}" step="0.01" min="0" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <input type="number" name="tax_rate" id="tax_rate" value="{{ old('tax_rate', '0') }}" step="0.0001" min="0" max="1" required
                ...
                <div class="mt-8 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span id="preview_name" class="ml-2 font-medium">-</span>
                        </div>
                        <div>
                            <span class="text-gray-600">Cost:</span>
                            <span id="preview_cost" class="ml-2 font-medium">-</span>
                        </div>
                        <div>
                            <span class="text-gray-600">Tax Rate:</span>
                            <span id="preview_tax" class="ml-2 font-medium">-</span>
                        </div>
                        <div>
                            <span class="text-gray-600">Modules:</span>
                            <span id="preview_modules" class="ml-2">-</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 flex justify-end space-x-3">
                    <a href="{{ route('packages.index', ['access_token' => $accessToken]) }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400">
                        Cancel
                    </a>
